  ...
  return (
    <div className="container-apropos">
      <p className="paragraphe-apropos">
        Actuellement en alternance à l'IUT Informatique de Sophia Antipolis, ma
        passion pour l'informatique s'est développée au fil des années,
        notamment dans le domaine du développement web. Mon objectif actuel est
        d'obtenir un diplôme Bac+3 grâce à ma formation en cours, et à plus long
        terme, je prévois de créer ma propre entreprise en ligne.
      </p>
      <p className="paragraphe-apropos">
        Je suis actuellement employé chez IANDI, où je participe au
        développement de leur logiciel 1SPECT, une solution complète de gestion
        dédiée aux métiers de l'inspection. Cette expérience me permet
        d'approfondir mes compétences en PHP, Symfony, JavaScript, Twig et
        Cypress.
      </p>
      <p className="paragraphe-apropos">
        Au fil du temps, j'ai réalisé divers projets, allant de simples sites en
        HTML/CSS à des sites fonctionnels combinant front-end (HTML/CSS pur
